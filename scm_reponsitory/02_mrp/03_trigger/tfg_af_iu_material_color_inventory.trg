CREATE OR REPLACE TRIGGER MRP.TFG_AF_IU_MATERIAL_COLOR_INVENTORY
  AFTER INSERT OR UPDATE ON MATERIAL_COLOR_INVENTORY
  FOR EACH ROW
DECLARE
...
BEGIN
  ...
  IF INSERTING THEN
    ...
    SCMDATA.PKG_PLAT_LOG.P_SYNC_RECORD_PLAT_LOG(P_COMPANY_ID         => V_COMPANY_ID,
                                                ...
                                                P_APPLY_MODULE_DESC  => '物料商色布库存盘点',
                                                P_BASE_TABLE         => 'MATERIAL_COLOR_INVENTORY',
