CREATE OR REPLACE TRIGGER MRP.TFG_AF_U_SUPPLIER_GREY_INVENTORY
AFTER UPDATE OF REMARKS ON SUPPLIER_GREY_INVENTORY
FOR EACH ROW
...
*/
  IF NVL(:NEW.REMARKS,1) <> NVL(:OLD.REMARKS,1) THEN
      scmdata.pkg_plat_log.p_record_plat_log(p_company_id         => v_company_id,
                                             p_apply_module       => 'a_prematerial_122',
                                             p_base_table         => 'SUPPLIER_GREY_INVENTORY',
