...
set define off
spool 20230614_trigger.log

prompt
prompt Creating trigger MRP_DETERMINE_SUPPLIER_CLASSIFICATION_MAPPING_ID_SEQ
prompt =====================================================================
prompt
@@mrp_determine_supplier_classification_mapping_id_seq.trg
prompt
...
prompt
prompt Creating trigger TRG_ABNORMALDTLCONFIG_BF_DEL
prompt =============================================
prompt
@@trg_abnormaldtlconfig_bf_del.trg
prompt
...
prompt
prompt Creating trigger TRG_AF_PT_ORDERDS_BYFILEDS
prompt ===========================================
prompt
@@trg_af_pt_orderds_byfileds.trg
prompt
...
prompt
prompt Creating trigger TRG_AF_U_SUP_INFO_OF_INSUPCODE
prompt ===============================================
prompt
@@trg_af_u_sup_info_of_insupcode.trg
prompt
...
prompt
prompt Creating trigger TRG_TOFACTORY_CAP
prompt ==================================
prompt
@@trg_tofactory_cap.trg
prompt
...
prompt
prompt Creating trigger TR_BF_D_SYS_APP_ROLE_GROUP
prompt ===========================================
prompt
@@tr_bf_d_sys_app_role_group.trg
prompt
