CREATE OR REPLACE PACKAGE SCMDATA.pkg_plat_comm IS
  ...
  *============================================*/
  ...
  /*=========================================================*
  * Author        : CZH55
  * Created_Time  : 2023-06-01 10:48:57
  * Alerter       : 
  * Alerter_Time  : 
  * Purpose       : 
  * Obj_Name      : F_QUERY_T_PLAT_LOG
  * Arg_Number    : 3
  * < IN PARAMS > : 3
  * P_APPLY_PK_ID : 单据字典
  * P_DICT_TYPE   : 日志类型（父级编码）
  * P_IS_FLHIDE_FILEDS : 是否隐藏字段
  *=========================================================*/
  FUNCTION f_query_t_plat_log(p_apply_pk_id      VARCHAR2,
                              p_dict_type        VARCHAR2 DEFAULT NULL,
  ...
  /*=========================================================*
  * Author        : CZH55
  * Created_Time  : 2023-06-01 11:03:55
  * Alerter       : 
  * Alerter_Time  : 
  ...
  * < OUT PARAMS >: 3
  * PO_PK_ID      : 主键
  * PO_REST_METHODS : REST方法（GET,POST,DELETE,PUT）
  * PO_PARAMS     : 请求参数
  *=========================================================*/
  ...
  /*=========================================================*
  * Author        : CZH55
  * Created_Time  : 2023-06-01 11:03:49
  * Alerter       : 
  * Alerter_Time  : 
  * Purpose       : asscoate data_sql
  *                 获取pkid，rest方法（POST;DELETE;PUT;GET）,动态参数
  ...
  *=========================================================*/
  ...
  /*=========================================================*
  * Author        : CZH55
  * Created_Time  : 2023-06-01 11:03:50
  * Alerter       : 
  * Alerter_Time  : 
  ...
  *=========================================================*/
  ...
  /*=========================================================*
  * Author        : CZH55
  * Created_Time  : 2023-06-01 11:03:47
  * Alerter       : 
  * Alerter_Time  : 
  ...
  * Arg_Number    : 6
  * < IN PARAMS > : 6
  * P_GROUP_DICT_TYPE : 字典类型
  * P_FIELD_VALUE : FIELD_VALUE
  * P_FIELD_DESC  : FIELD_DESC
  * P_COMPANY_ID  : 企业ID
  * P_IS_COMPANY_DICT : 是否是企业级字段 1：是，0：否
  * P_WHERE_SQL   : 条件SQL
  *=========================================================*/
  ...
  /*=========================================================*
  * Author        : CZH55
  * Created_Time  : 2023-06-01 11:03:48
  * Alerter       : 
  * Alerter_Time  : 
  ...
  * < IN PARAMS > : 17
  * P_GROUP_DICT_TYPE : 字典类型
  * P_DICT_VALUE  : DICT_VALUE
  * P_DICT_DESC   : DICT_DESC
  * P_WHERE_SQL   : 条件SQL
  * P_IS_SET_OTHER_FD : 是否设置其它字段为空 1：是，0：否
  * P_IS_COMPANY_DICT : 是否是企业字典 1：是，0：否
  * P_COMPANY_ID  : 企业ID
  * P_SETNULL_FDVALUE_1 : 置空字段VALUE_1
  * P_SETNULL_FDDESC_1 : 置空字段DESC_1
  * P_SETNULL_FDVALUE_2 : 置空字段VALUE_2
  * P_SETNULL_FDDESC_2 : 置空字段DESC_2
  * P_SETNULL_FDVALUE_3 : 置空字段VALUE_3
  * P_SETNULL_FDDESC_3 : 置空字段DESC_3
  * P_SETNULL_FDVALUE_4 : 置空字段VALUE_4
  * P_SETNULL_FDDESC_4 : 置空字段DESC_4
  * P_SETNULL_FDVALUE_5 : 置空字段VALUE_5
  * P_SETNULL_FDDESC_5 : 置空字段DESC_5
  *=========================================================*/
  ...
  /*=========================================================*
  * Author        : CZH55
  * Created_Time  : 2023-06-01 11:03:53
  * Alerter       : 
  * Alerter_Time  : 
  * Purpose       : json解析
  ...
  *=========================================================*/
  ...
  /*=========================================================*
  * Author        : CZH55
  * Created_Time  : 2023-06-01 11:03:52
  * Alerter       : 
  * Alerter_Time  : 
  * Purpose       : 判断字段新旧值是否相等
  * Obj_Name      : F_IS_CHECK_FIELDS_EQ
  * Arg_Number    : 2
  * < IN PARAMS > : 2
  * P_OLD_FIELD   : 旧值
  * P_NEW_FIELD   : 薪资
...
CREATE OR REPLACE PACKAGE BODY SCMDATA.pkg_plat_comm IS
  ...
  */
  ...
  BEGIN
    ...
    /*0：所有企业都允许;1.只有采购方;2.只有成品供应商;3.采购方%供应商；4.面料供应商*/
    IF v_company_role = 'supp' AND v_apply_belong NOT IN (0, 2, 3) OR --通用+采购方应用之外的没权限
       v_company_role = 'need' AND v_apply_belong NOT IN (0, 1, 3) OR --通用+成品供应商应用之外的没权限
       v_company_role = 'mrpp' AND v_apply_belong NOT IN (0, 4, 3) THEN
      --2023.2.11 add:通用+面料供应商应用之外的没权限
      v_result := 0;
      RETURN v_result;
    ELSE
      NULL;
  ...
  BEGIN
    v_sql := 'SELECT a.group_dict_name log_type,
      ...
      LEFT JOIN scmdata.sys_group_dict a
        ON a.group_dict_type = nvl(''' || p_dict_type ||
             ''',t.log_parent_type)
  ...
  BEGIN
    ...
    ELSIF p_is_company_dict = 1 THEN
      ...
      v_sql := q'[SELECT t.company_dict_value ]' || p_field_value ||
       ...
       ORDER BY t.company_dict_sort  ASC]';
    END IF;
