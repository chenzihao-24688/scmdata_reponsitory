--根据企业变更
DECLARE
  v_licence_num      VARCHAR2(256) := '91440101MA9W4G6M6J';
  v_user_account_new VARCHAR2(256) := '18613133824';
BEGIN
...
--根据企业变更
DECLARE
  v_licence_num      VARCHAR2(256) := '91420902MA49265Q4H';
  v_user_account_new VARCHAR2(256) := '18688492571';
BEGIN
  FOR user_rec IN (SELECT a.attributor_id user_id, b.user_account user_account_old
                     FROM scmdata.sys_company a
                    INNER JOIN scmdata.sys_user b
