  ...
  BEGIN
    ...
    IF v_flag > 0 THEN
      IF v_factrory_ask_flow_status IN ('FA12', 'FA31') THEN     
        ...
        iv_supp_info.company_vill                  := fask_rec.company_vill;
  ...
  *============================================*/
  ...
  BEGIN
    ...
    INSERT INTO scmdata.t_supplier_info
      (supplier_info_id, company_id, supplier_info_origin_id,
       supplier_company_id, supplier_company_name,
       supplier_company_abbreviation, social_credit_code,
       inside_supplier_code, company_contact_person, company_contact_phone,
       legal_representative, fa_contact_name, fa_contact_phone,
       company_address, certificate_file, cooperation_type,
       cooperation_model, sharing_type, supplier_info_origin, pause, status,
       bind_status, create_id, create_date, update_id, update_date,
       company_province, company_city, company_county, company_vill,
       coop_state, group_name, area_group_leader, coop_position,
       product_type, product_link, brand_type, cooperation_brand,
       product_line, product_line_num, worker_num, machine_num, quality_step,
       pattern_cap, fabric_purchase_cap, fabric_check_cap, cost_step,
       --reserve_capacity,
       product_efficiency, work_hours_day, remarks, company_type,
       supplier_gate, supplier_office, supplier_site, supplier_product,
       file_remark, ask_files, admit_result)
    VALUES
      (p_sp_data.supplier_info_id, p_sp_data.company_id,
       p_sp_data.supplier_info_origin_id, p_sp_data.supplier_company_id,
       p_sp_data.supplier_company_name,
       p_sp_data.supplier_company_abbreviation, p_sp_data.social_credit_code,
       p_sp_data.inside_supplier_code, p_sp_data.company_contact_person,
       p_sp_data.company_contact_phone, p_sp_data.legal_representative,
       p_sp_data.fa_contact_name, p_sp_data.fa_contact_phone,
       p_sp_data.company_address, p_sp_data.certificate_file,
       p_sp_data.cooperation_type, p_sp_data.cooperation_model,
       p_sp_data.sharing_type, p_sp_data.supplier_info_origin,
       p_sp_data.pause, '0', p_sp_data.bind_status, p_sp_data.create_id,
       SYSDATE, p_sp_data.create_id, SYSDATE, p_sp_data.company_province,
       p_sp_data.company_city, p_sp_data.company_county,
       p_sp_data.company_vill, p_sp_data.coop_state, p_sp_data.group_name,
       p_sp_data.area_group_leader, p_sp_data.coop_position,
       p_sp_data.product_type, p_sp_data.product_link, p_sp_data.brand_type,
       p_sp_data.cooperation_brand, p_sp_data.product_line,
       ...
       p_sp_data.remarks, p_sp_data.company_type, p_sp_data.supplier_gate,
       p_sp_data.supplier_office, p_sp_data.supplier_site,
       p_sp_data.supplier_product, p_sp_data.file_remark,
       p_sp_data.ask_files, p_sp_data.admit_result);
