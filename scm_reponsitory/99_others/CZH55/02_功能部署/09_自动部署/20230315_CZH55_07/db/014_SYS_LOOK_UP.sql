...
BEGIN
  DECLARE
    ...
    EXE_SQL CLOB;
    VALS    CLOB;
  CV1 CLOB:=q'^{DECLARE v_sql CLOB; BEGIN v_sql := pkg_ask_record_mange.f_query_supply_type_looksql(p_supply_type_field => 'FACTORY_COOP_MODEL',p_suffix => '_DESC');  ^'|| CHR(64) ||q'^strresult := v_sql; END; }^';
  CV2 CLOB:=q'^^';
