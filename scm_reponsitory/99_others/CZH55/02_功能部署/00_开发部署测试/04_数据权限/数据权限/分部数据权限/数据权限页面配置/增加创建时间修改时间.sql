...
update nbw.sys_item_list t set t.noshow_fields = v_str1,t.insert_sql = v_str2 WHERE t.item_id = 'c_2058';

update nbw.sys_item_list t set t.insert_sql = v_str3 WHERE t.item_id = 'c_2076';
