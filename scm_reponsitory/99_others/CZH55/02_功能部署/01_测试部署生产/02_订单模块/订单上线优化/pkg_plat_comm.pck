CREATE OR REPLACE PACKAGE pkg_plat_comm IS
  ...
  *============================================*/
  ...
  FUNCTION f_get_username(p_user_id         VARCHAR2,
                          ...
                          p_is_mutival      INT DEFAULT 0) RETURN VARCHAR2;
  --czh add 获取供应商名称                      
  ...
  --czh add 查询平台操作日志
  FUNCTION f_query_t_plat_log(p_apply_pk_id VARCHAR2, p_dict_type VARCHAR2)
    RETURN CLOB;

END pkg_plat_comm;
/
CREATE OR REPLACE PACKAGE BODY pkg_plat_comm IS
  ...
  *============================================*/
  ...
  FUNCTION f_get_username(p_user_id         VARCHAR2,
                          p_company_id      VARCHAR2 DEFAULT NULL,
                          p_is_company_user INT DEFAULT 0,
                          p_is_mutival      INT DEFAULT 0) RETURN VARCHAR2 IS
    v_name VARCHAR2(256);
  BEGIN
  ...
  *============================================*/
  ...
  BEGIN
    v_sql := 'SELECT a.group_dict_name log_type,
      ...
      LEFT JOIN scmdata.sys_user su on su.user_id = t.operater
