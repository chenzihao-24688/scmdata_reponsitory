...
SELECT t.product_gress_id,
 ...
 WHERE oh.company_id = %default_company_id% AND ((%is_company_admin%) = 1 OR instr_priv(p_str1 => '''''' ||
  ...
  @strresult := v_sql;
END;}';
update bw3.sys_item_list t set t.select_sql = v_sql,t.subselect_sql = null where t.item_id = 'a_product_110';
END;
/
declare
v_sql clob;
...
SELECT t.product_gress_id,
 ...
 ORDER BY t.product_gress_code DESC, oh.finish_time_scm DESC'';
  @strresult := v_sql;
END;}';
update bw3.sys_item_list t set t.select_sql = v_sql,t.subselect_sql = null where t.item_id = 'a_product_116';
end;
