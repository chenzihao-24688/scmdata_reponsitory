      ...
      SELECT DISTINCT *
        ...
        UPDATE
           SET pta.year                   = ptb.year,
               ...
               pta.flw_order_manager      = f_get_manager(p_company_id     => ptb.company_id,
                                                          p_user_id        => ptb.flw_order,
                                                          p_company_job_id => '1001005003005002'), --ptb.flw_order_manager,
               pta.qc                     = ptb.qc,
               pta.qc_manager             = f_get_manager(p_company_id     => ptb.company_id,
                                                          p_user_id        => ptb.qc,
      ...
      WHEN NOT MATCHED THEN
        ...
        VALUES
          (scmdata.f_get_uuid(),
           ...
           ptb.style_number,
           ptb.flw_order,
           f_get_manager(p_company_id     => ptb.company_id,
                         p_user_id        => ptb.flw_order,
                         p_company_job_id => '1001005003005002') /*ptb.flw_order_manager*/,
           ptb.qc,
           f_get_manager(p_company_id     => ptb.company_id,
