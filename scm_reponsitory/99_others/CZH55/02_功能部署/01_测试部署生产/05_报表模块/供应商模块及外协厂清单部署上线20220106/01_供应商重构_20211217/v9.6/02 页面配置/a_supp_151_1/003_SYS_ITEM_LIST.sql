...
{DECLARE
  v_sql CLOB;
BEGIN
  v_sql      := pkg_supplier_info.f_delete_sup_coop_list(p_item_id => 'a_supp_151_1');
  @strresult := v_sql;
END;}
--原逻辑
/*DECLARE
...
{DECLARE
  v_sql CLOB;
BEGIN
  v_sql      := pkg_supplier_info.f_insert_sup_coop_list(p_item_id => 'a_supp_151_1');
  @strresult := v_sql;
END;}
--原逻辑
/*DECLARE
...
{DECLARE
  v_sql CLOB;
BEGIN
  v_sql      := pkg_supplier_info.f_query_sup_coop_list(p_item_id => 'a_supp_151_1');
  @strresult := v_sql;
END;}
--原逻辑
/*
SELECT tc.coop_scope_id,
...
{DECLARE
  v_sql CLOB;
BEGIN
  v_sql      := pkg_supplier_info.f_update_sup_coop_list(p_item_id => 'a_supp_151_1');
  @strresult := v_sql;
END;}
--原逻辑
/*DECLARE
