...
BEGIN
  ...
  END IF;
  --1.更新所在分组，区域组长
  pkg_supplier_info.update_group_name(p_company_id  => %default_company_id%,p_supplier_info_id => :supplier_info_id);]' || CASE
...
END;]';
 ...
 INNER JOIN scmdata.t_supplier_info sp
   ...
   AND f.factory_code = sp.supplier_code
...
END;}';
  ...
  BEGIN
    IF p_pause_type = 'SUP' THEN
      UPDATE scmdata.t_coop_factory t
         SET t.pause = p_status, t.pause_type = p_pause_type
  ...
  *============================================*/
  ...
  BEGIN
    ...
    ELSE
      ...
      --4.新需求逻辑  建档后自动生成本厂信息至合作工厂
      DECLARE
        v_fac_rec      scmdata.t_coop_factory%ROWTYPE;
        v_factory_name VARCHAR2(32);
      BEGIN
        v_fac_rec.coop_factory_id := scmdata.f_get_uuid();
  ...
  *============================================*/
  ...
  BEGIN
    ...
    IF p_sp_data.supplier_info_origin = 'MA' AND p_sp_data.status = 0 THEN
      ...
      p_sp_data.product_efficiency, p_sp_data.work_hours_day, p_sp_data.pause, p_sp_data.cooperation_model, p_sp_data.coop_position, p_sp_data.certificate_file, p_sp_data.ask_files, p_sp_data.supplier_gate, p_sp_data.supplier_office, p_sp_data.supplier_site, p_sp_data.supplier_product, p_sp_data.company_say, p_sp_data.file_remark, p_sp_data.update_id, SYSDATE, p_sp_data.supplier_info_id;
    ELSE
      EXECUTE IMMEDIATE v_update_sql
