CREATE OR REPLACE PACKAGE pkg_factory_inspection IS
...
/
CREATE OR REPLACE PACKAGE BODY PKG_FACTORY_INSPECTION IS
  ...
  BEGIN
    ...
    FOR I IN (SELECT A.COOPERATION_TYPE ATYPE,
                ...
                LEFT JOIN (SELECT COOPERATION_CLASSIFICATION,
                 ...
                 AND A.COOPERATION_SUBCATEGORY = B.COOPERATION_SUBCATEGORY) LOOP
