...
SELECT ROWID, t.* FROM bwptest1.sys_element t where t.element_id in ('action_itf_a_supp_140','action_itf_a_supp_141');
SELECT ROWID, t.* FROM bwptest1.sys_action t where t.element_id in ('action_itf_a_supp_140','action_itf_a_supp_141');
SELECT ROWID, t.* FROM bwptest1.sys_item_element_rela t where t.element_id in ('action_itf_a_supp_140','action_itf_a_supp_141');
