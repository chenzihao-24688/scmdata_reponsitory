...
values ('pick_a_supp_160_1', 'pick', 'oracle_scmdata', 0, null, null, null, null, null, null);
...
values ('pick_a_supp_160_1', 'AR_COMPANY_VILL_DESC_Y', '公司所在区域', 'SELECT a.villid ar_company_vill_y, a.vill ar_company_vill_desc_y
  FROM scmdata.dic_village a
 INNER JOIN scmdata.dic_county b
    ON a.countyid = b.countyid
 WHERE a.countyid = :company_county
   AND a.pause = 0
   AND b.pause = 0', 'AR_COMPANY_VILL_DESC_Y', 'AR_COMPANY_VILL_DESC_Y', 'AR_COMPANY_VILL_Y,AR_COMPANY_VILL_DESC_Y', 'AR_COMPANY_VILL_DESC_Y', null, null, null, null, null, null, 0, null, null, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_supp_161', 'pick_a_supp_160_1', 3, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_supp_151', 'pick_a_supp_160_1', 3, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_151', 'pick_a_supp_160_1', 3, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_150_3', 'pick_a_supp_160_1', 3, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_104', 'pick_a_supp_160_1', 3, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_221', 'pick_a_supp_160_1', 3, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_311', 'pick_a_supp_160_1', 3, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_150_6', 'pick_a_supp_160_1', 3, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_211', 'pick_a_supp_160_1', 3, 0, null);
...
values ('f4dcf5fc03597986e0533c281cac679b', 'ae37b0b7d3ae27f0e055025056876ded', 'ae37b0b7d3ae27f0e055025056876ded', '直播专供', 'DLB', 'SUPPLY_TYPE', null, 8, '1', 1, 1, 0, 'CZH', to_date('17-02-2023 10:20:45', 'dd-mm-yyyy hh24:mi:ss'), 'CZH', to_date('17-02-2023 10:20:45', 'dd-mm-yyyy hh24:mi:ss'), null, 0, 0, '0', null, null, null, null);

insert into scmdata.sys_group_dict (GROUP_DICT_ID, PARENT_ID, PARENT_IDS, GROUP_DICT_NAME, GROUP_DICT_VALUE, GROUP_DICT_TYPE, DESCRIPTION, GROUP_DICT_SORT, GROUP_DICT_STATUS, TREE_LEVEL, IS_LEAF, IS_INITIAL, CREATE_ID, CREATE_TIME, UPDATE_ID, UPDATE_TIME, REMARKS, DEL_FLAG, PAUSE, IS_COMPANY_DICT_RELA, EXTEND_01, EXTEND_02, EXTEND_03, EXTEND_04)
values ('f4dcf5fc035a7986e0533c281cac679b', 'ae37b0b7d3ae27f0e055025056876ded', 'ae37b0b7d3ae27f0e055025056876ded', '现货供应', 'SPS', 'SUPPLY_TYPE', null, 9, '1', 1, 1, 0, 'CZH', to_date('17-02-2023 10:20:45', 'dd-mm-yyyy hh24:mi:ss'), 'CZH', to_date('17-02-2023 10:20:45', 'dd-mm-yyyy hh24:mi:ss'), null, 0, 0, '0', null, null, null, null);
END;
/
DECLARE
v_sql CLOB;
...
insert into bw3.sys_element (ELEMENT_ID, ELEMENT_TYPE, DATA_SOURCE, PAUSE, MESSAGE, IS_HIDE, MEMO, IS_ASYNC, IS_PER_EXE, ENABLE_STAND_PERMISSION)
values ('pick_a_coop_151_10', 'pick', 'oracle_scmdata', 0, null, null, null, null, null, null);

insert into bw3.sys_element (ELEMENT_ID, ELEMENT_TYPE, DATA_SOURCE, PAUSE, MESSAGE, IS_HIDE, MEMO, IS_ASYNC, IS_PER_EXE, ENABLE_STAND_PERMISSION)
values ('pick_a_coop_151_11', 'pick', 'oracle_scmdata', 0, null, null, null, null, null, null);
/*
v_sql := q'[
{
DECLARE
...
BEGIN
  IF :ar_cooperation_model_y IS NULL OR :ar_cooperation_model_y = 'OF' THEN
    v_where_sql := 'WHERE 1 = 0';
  ELSE
    v_where_sql := 'WHERE 1 = 1';
  END IF;
  v_sql      := scmdata.pkg_plat_comm.f_get_picksql_by_type(p_group_dict_type => 'PAY_TERM',
                                                            p_dict_value      => 'AR_PAY_TERM_N',
                                                            p_dict_desc       => 'AR_PAY_TERM_DESC_N');
  @strresult := v_sql;
END;
}]';
insert into bw3.sys_pick_list (ELEMENT_ID, FIELD_NAME, CAPTION, PICK_SQL, FROM_FIELD, QUERY_FIELDS, OTHER_FIELDS, TREE_FIELDS, LEVEL_FIELD, IMAGE_NAMES, TREE_ID, SEPERATOR, MULTI_VALUE_FLAG, RECURSION_FLAG, CUSTOM_QUERY, NAME_LIST_SQL, PORT_ID, PORT_SQL)
values ('pick_a_coop_151_10', 'AR_PAY_TERM_DESC_N', '付款条件', v_sql, 'AR_PAY_TERM_DESC_N', 'AR_PAY_TERM_DESC_N', 'AR_PAY_TERM_DESC_N,AR_PAY_TERM_N', 'AR_PAY_TERM_DESC_N', null, null, null, null, null, 0, 0, null, null, null);
*/
v_sql1 := q'[
{
DECLARE
...
BEGIN
  IF :ar_cooperation_model_y IS NULL THEN
    v_where_sql := 'WHERE 1 = 0';
  ELSE
    IF :ar_cooperation_model_y = 'OF' THEN
      v_where_sql := 'WHERE 1 = 1';
    ELSE
      v_where_sql := 'WHERE AR_PRODUCT_TYPE_Y = ''00''';
    END IF;
  END IF;
  v_sql      := scmdata.pkg_plat_comm.f_get_picksql_by_type(p_group_dict_type => 'FA_PRODUCT_TYPE',
                                                            p_dict_value      => 'AR_PRODUCT_TYPE_Y',
                                                            p_dict_desc       => 'AR_PRODUCT_TYPE_DESC_Y',
                                                            p_where_sql       => v_where_sql);
  @strresult := v_sql;
END;
}]';
insert into bw3.sys_pick_list (ELEMENT_ID, FIELD_NAME, CAPTION, PICK_SQL, FROM_FIELD, QUERY_FIELDS, OTHER_FIELDS, TREE_FIELDS, LEVEL_FIELD, IMAGE_NAMES, TREE_ID, SEPERATOR, MULTI_VALUE_FLAG, RECURSION_FLAG, CUSTOM_QUERY, NAME_LIST_SQL, PORT_ID, PORT_SQL)
values ('pick_a_coop_151_11', 'AR_PRODUCT_TYPE_DESC_Y', '生产类型', v_sql1, 'AR_PRODUCT_TYPE_DESC_Y', 'AR_PRODUCT_TYPE_DESC_Y', 'AR_PRODUCT_TYPE_DESC_Y,AR_PRODUCT_TYPE_Y', 'AR_PRODUCT_TYPE_DESC_Y', null, null, null, null, null, 0, 0, null, null, null);
/*
insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_151', 'pick_a_coop_151_10', 5, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_150_3', 'pick_a_coop_151_10', 5, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_supp_151', 'pick_a_coop_151_10', 9, 0, null);*/

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_150_3', 'pick_a_coop_151_11', 6, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_151', 'pick_a_coop_151_11', 6, 0, null);
...
insert into bw3.sys_element (ELEMENT_ID, ELEMENT_TYPE, DATA_SOURCE, PAUSE, MESSAGE, IS_HIDE, MEMO, IS_ASYNC, IS_PER_EXE, ENABLE_STAND_PERMISSION)
values ('control_a_supp_151_1', 'control', 'oracle_scmdata', 0, null, null, null, null, null, null);

insert into bw3.sys_element (ELEMENT_ID, ELEMENT_TYPE, DATA_SOURCE, PAUSE, MESSAGE, IS_HIDE, MEMO, IS_ASYNC, IS_PER_EXE, ENABLE_STAND_PERMISSION)
values ('pick_a_supp_111_5', 'pick', 'oracle_scmdata', 0, null, null, null, null, null, null);

insert into bw3.sys_element (ELEMENT_ID, ELEMENT_TYPE, DATA_SOURCE, PAUSE, MESSAGE, IS_HIDE, MEMO, IS_ASYNC, IS_PER_EXE, ENABLE_STAND_PERMISSION)
values ('pick_a_supp_111_6', 'pick', 'oracle_scmdata', 0, null, null, null, null, null, null);

insert into bw3.sys_element (ELEMENT_ID, ELEMENT_TYPE, DATA_SOURCE, PAUSE, MESSAGE, IS_HIDE, MEMO, IS_ASYNC, IS_PER_EXE, ENABLE_STAND_PERMISSION)
values ('pick_a_supp_111_7', 'pick', 'oracle_scmdata', 0, null, null, null, null, null, null);
...
BEGIN
  IF :sp_cooperation_model_y IS NULL THEN
    v_where_sql := ''WHERE 1 = 0'';
  ELSE
    IF :sp_cooperation_model_y = ''OF'' THEN
      v_where_sql := ''WHERE 1 = 1'';
    ELSE
      v_where_sql := ''WHERE SP_PRODUCT_TYPE_Y = ''''00'''''';
    END IF;
  END IF;
  v_sql      := scmdata.pkg_plat_comm.f_get_picksql_by_type(p_group_dict_type => ''FA_PRODUCT_TYPE'',
                                                            p_dict_value      => ''SP_PRODUCT_TYPE_Y'',
                                                            p_dict_desc       => ''SP_PRODUCT_TYPE_DESC_Y'',
                                                            p_where_sql       => v_where_sql);
  @strresult := v_sql;
END;
}';
insert into bw3.sys_pick_list (ELEMENT_ID, FIELD_NAME, CAPTION, PICK_SQL, FROM_FIELD, QUERY_FIELDS, OTHER_FIELDS, TREE_FIELDS, LEVEL_FIELD, IMAGE_NAMES, TREE_ID, SEPERATOR, MULTI_VALUE_FLAG, RECURSION_FLAG, CUSTOM_QUERY, NAME_LIST_SQL, PORT_ID, PORT_SQL)
values ('pick_a_supp_111_5', 'SP_PRODUCT_TYPE_DESC_Y', '生产类型', v_sql1, 'SP_PRODUCT_TYPE_DESC_Y', 'SP_PRODUCT_TYPE_DESC_Y', 'SP_PRODUCT_TYPE_DESC_Y,SP_PRODUCT_TYPE_Y', 'SP_PRODUCT_TYPE_DESC_Y', null, null, null, null, null, 0, 0, null, null, null);
...
BEGIN
  ...
  ELSE
    ...
    ELSE
      v_where_sql := q''[WHERE SP_COMPANY_TYPE_Y = ''01'']'';
    END IF;
  END IF;
...
insert into bw3.sys_pick_list (ELEMENT_ID, FIELD_NAME, CAPTION, PICK_SQL, FROM_FIELD, QUERY_FIELDS, OTHER_FIELDS, TREE_FIELDS, LEVEL_FIELD, IMAGE_NAMES, TREE_ID, SEPERATOR, MULTI_VALUE_FLAG, RECURSION_FLAG, CUSTOM_QUERY, NAME_LIST_SQL, PORT_ID, PORT_SQL)
values ('pick_a_supp_111_6', 'SP_COMPANY_TYPE_DESC_Y', '公司类型', v_sql2, 'SP_COMPANY_TYPE_DESC_Y', 'SP_COMPANY_TYPE_DESC_Y', 'SP_COMPANY_TYPE_DESC_Y,SP_COMPANY_TYPE_Y', 'SP_COMPANY_TYPE_DESC_Y', null, null, null, null, 0, 0, 0, null, null, null);

v_sql3 := '{
DECLARE
  v_sql CLOB;
BEGIN
  v_sql      := scmdata.pkg_plat_comm.f_get_picksql_by_type(p_group_dict_type   => ''SUPPLY_TYPE'',
                                                            p_dict_value        => ''SP_COOPERATION_MODEL_Y'',
                                                            p_dict_desc         => ''SP_COOP_MODEL_DESC_Y'',
                                                            p_is_set_other_fd   => 1,
                                                            p_setnull_fdvalue_1 => ''SP_COMPANY_TYPE_Y'',
                                                            p_setnull_fddesc_1  => ''SP_COMPANY_TYPE_DESC_Y'',
                                                            p_setnull_fdvalue_2 => ''AR_PAY_TERM_N'',
                                                            p_setnull_fddesc_2  => ''AR_PAY_TERM_DESC_N'',
                                                            p_setnull_fdvalue_3 => ''SP_PRODUCT_TYPE_Y'',
                                                            p_setnull_fddesc_3  => ''SP_PRODUCT_TYPE_DESC_Y'');
  @strresult := v_sql;
END;
}';

insert into bw3.sys_pick_list (ELEMENT_ID, FIELD_NAME, CAPTION, PICK_SQL, FROM_FIELD, QUERY_FIELDS, OTHER_FIELDS, TREE_FIELDS, LEVEL_FIELD, IMAGE_NAMES, TREE_ID, SEPERATOR, MULTI_VALUE_FLAG, RECURSION_FLAG, CUSTOM_QUERY, NAME_LIST_SQL, PORT_ID, PORT_SQL)
values ('pick_a_supp_111_7', 'SP_COOP_MODEL_DESC_Y', '意向合作模式', v_sql3, 'SP_COOP_MODEL_DESC_Y', 'SP_COOP_MODEL_DESC_Y', 'SP_COOP_MODEL_DESC_Y,SP_COOPERATION_MODEL_Y,SP_COMPANY_TYPE_DESC_Y,SP_COMPANY_TYPE_Y,AR_PAY_TERM_N,AR_PAY_TERM_DESC_N,SP_PRODUCT_TYPE_Y,SP_PRODUCT_TYPE_DESC_Y', 'SP_COOP_MODEL_DESC_Y', null, null, null, ' ', 1, 0, 0, null, null, null);

insert into bw3.sys_field_control (ELEMENT_ID, FROM_FIELD, CONTROL_EXPRESS, CONTROL_FIELDS, CONTROL_TYPE)
values ('control_a_supp_151_1', 'SP_COOP_MODEL_DESC_Y', '''{{SP_COOP_MODEL_DESC_Y}}''!=''外协工厂''&''{{SP_COOP_MODEL_DESC_Y}}''!=''''', 'AR_PAY_TERM_DESC_N', 0);


insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_supp_151', 'control_a_supp_151_1', 1, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_supp_151', 'pick_a_supp_111_5', 3, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_supp_151', 'pick_a_supp_111_6', 3, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_supp_151', 'pick_a_supp_111_7', 3, 0, null);
...
values ('SP_COOP_MODEL_DESC_Y', '合作模式', 1, null, null, null, null, null, 0, 0, 0, null, 0, 0, null, null, null, null, null, null, null, null, null, 0, 0, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_150_3', 'control_a_coop_151_1', 1, 0, null);
...
BEGIN
  v_sql1 := 'DECLARE
  p_factory_ask_type         VARCHAR2(32) := @factory_ask_type@;
  p_memo                     VARCHAR2(600) := @remarks@;
...
BEGIN
  ...
  scmdata.pkg_ask_record_mange.p_update_flow_status_and_logger(p_company_id       => %default_company_id%,
                                                               ...
                                                               p_flow_af_status   => p_factrory_ask_flow_status, --操作后流程状态
                                                               p_memo             => p_memo);
  /* 原代码
    IF p_factory_ask_type = 0 THEN
  ...
  */
  ...
  IF p_factory_ask_type = 0 THEN
    ...
    scmdata.pkg_send_wx_msg.p_platform_person_wx_msg_push(v_company_id   => %default_company_id%,
                                                          ...
                                                          v_pattern_code => ''FA_AUDIT_00'',
                                                          v_user_id      => '''',
                                                          v_type         => 1);
  ELSIF p_factory_ask_type = 1 THEN
    ---内部验厂  dcc
    scmdata.pkg_send_wx_msg.p_platform_person_wx_msg_push(v_company_id   => %default_company_id%,
                                                          v_supplier     => v_company_name,
                                                          v_pattern_code => ''FA_AUDIT_01'',
                                                          v_user_id      => '''',
                                                          v_type         => 1);
  END IF;
  --lsl end
...
BEGIN
  ...
  scmdata.pkg_send_wx_msg.p_platform_person_wx_msg_push(v_company_id   => %default_company_id%,
                                                        v_supplier     => v_company_name,
                                                        v_pattern_code => ''FA_AUDIT_02'',
                                                        v_user_id      => v_ask_user_id,
                                                        v_type         => 0);
  --lsl end
END;';
 insert into bw3.sys_element (ELEMENT_ID, ELEMENT_TYPE, DATA_SOURCE, PAUSE, MESSAGE, IS_HIDE, MEMO, IS_ASYNC, IS_PER_EXE, ENABLE_STAND_PERMISSION)
values ('action_a_coop_220_21', 'action', 'oracle_scmdata', 0, null, null, null, null, null, null);

insert into bw3.sys_element (ELEMENT_ID, ELEMENT_TYPE, DATA_SOURCE, PAUSE, MESSAGE, IS_HIDE, MEMO, IS_ASYNC, IS_PER_EXE, ENABLE_STAND_PERMISSION)
values ('action_a_coop_220_22', 'action', 'oracle_scmdata', 0, null, null, null, null, null, null);
...
values ('action_a_coop_220_21', '同意', null, 4, v_sql1, null, 3, 1, null, null, null, null, null, null, 0, null, 1, 1, null, 1);

insert into bw3.sys_action (ELEMENT_ID, CAPTION, ICON_NAME, ACTION_TYPE, ACTION_SQL, SELECT_FIELDS, REFRESH_FLAG, MULTI_PAGE_FLAG, PRE_FLAG, FILTER_EXPRESS, UPDATE_FIELDS, PORT_ID, PORT_SQL, LOCK_SQL, SELECTION_FLAG, CALL_ID, OPERATE_MODE, PORT_TYPE, QUERY_FIELDS, SELECTION_METHOD)
values ('action_a_coop_220_22', '不同意', null, 4, v_sql2, null, 3, 1, null, null, null, null, null, null, 0, null, 1, 1, null, 1); 

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_150_3', 'action_a_coop_220_21', 1, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_150_3', 'action_a_coop_220_22', 2, 0, null);

insert into bw3.sys_cond_list (COND_ID, COND_SQL, COND_TYPE, SHOW_TEXT, DATA_SOURCE, COND_FIELD_NAME, MEMO)
values ('cond_a_coop_220', '{
DECLARE
  v_sql         CLOB;
  v_flow_status VARCHAR2(32);
BEGIN
  --因验厂申请页面（待审批，已审批 获取不了%ass_ask_record_id%）
  --做特殊处理                                      
  SELECT MAX(t.factrory_ask_flow_status)
    ...
    FROM scmdata.t_factory_ask t
   WHERE t.factory_ask_id = :factory_ask_id;
  IF v_flow_status IN (''FA01'', ''FA02'') THEN
...
values ('cond_a_coop_220', 91, 'action_a_coop_220_21', 0, 1, 0, null);

insert into bw3.sys_cond_rela (COND_ID, OBJ_TYPE, CTL_ID, CTL_TYPE, SEQ_NO, PAUSE, ITEM_ID)
values ('cond_a_coop_220', 91, 'action_a_coop_220_22', 0, 1, 0, null);
...
DECLARE
  ...
  rest_arr          rest_arrs := NEW rest_arrs(@selection);
...
insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_150_3', 'control_a_coop_151_3', 3, 0, null);
...
BEGIN
insert into bw3.sys_element (ELEMENT_ID, ELEMENT_TYPE, DATA_SOURCE, PAUSE, MESSAGE, IS_HIDE, MEMO, IS_ASYNC, IS_PER_EXE, ENABLE_STAND_PERMISSION)
values ('control_a_coop_310_1', 'control', 'oracle_scmdata', 0, null, null, null, null, null, null);

insert into bw3.sys_field_control (ELEMENT_ID, FROM_FIELD, CONTROL_EXPRESS, CONTROL_FIELDS, CONTROL_TYPE)
values ('control_a_coop_310_1', 'FACTRORY_ASK_FLOW_STATUS', '''{{FACTRORY_ASK_FLOW_STATUS}}''!=''FA31''', 'action_a_coop_310_3', 2);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_coop_310', 'control_a_coop_310_1', 1, 0, null);
END;
/
DECLARE
  v_sql CLOB;
