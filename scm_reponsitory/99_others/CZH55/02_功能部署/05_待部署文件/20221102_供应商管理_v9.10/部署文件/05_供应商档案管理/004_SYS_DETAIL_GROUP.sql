...
BEGIN
  DECLARE
    ...
    EXE_SQL CLOB;
    VALS    CLOB;
  CV1 CLOB:=q'^supplier_company_name,supplier_company_abbreviation,SUPPLIER_CODE,SOCIAL_CREDIT_CODE,LEGAL_REPRESENTATIVE,INSIDE_SUPPLIER_CODE,location_area,COMPANY_VILL,company_address_sp,group_name,company_contact_phone,FA_CONTACT_NAME,FA_CONTACT_PHONE,company_type,file_remark^';
...
BEGIN
  DECLARE
    ...
    EXE_SQL CLOB;
    VALS    CLOB;
  CV1 CLOB:=q'^certificate_file_sp,ASK_FILES_SP,SUPPLIER_GATE,SUPPLIER_OFFICE,SUPPLIER_SITE,SUPPLIER_PRODUCT^';
