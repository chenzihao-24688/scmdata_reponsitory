prompt Importing table bwptest1.sys_port_map...
set feedback off
set define off
insert into bwptest1.sys_port_map (PORT_NAME, FIELD_NAME, PATH_NAME, AS_ARRAY, DEFAULT_VALUE, SEQNO, METHOD_ID, IS_REQUIRE, TYPE)
