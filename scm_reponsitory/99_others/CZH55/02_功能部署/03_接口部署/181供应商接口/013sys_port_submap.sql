prompt Importing table bwptest1.sys_port_submap...
set feedback off
set define off
insert into bwptest1.sys_port_submap (FIELD_NAME, CONVERT_NAME, DEFAULT_VALUE, PARENT_FIELD_NAME, SEQNO, IS_REQUIRE)
