...
select a.factory_ask_id,
 ...
 order by a.is_urgent DESC nulls last,k.audit_time desc]';
    ...
    SELECT (SELECT dept_name
           ...
           (SELECT t.supplier_company_name
             ...
             WHERE t.company_id = tfa.company_id
               AND t.social_credit_code = tfa.rela_supplier_id) rela_supplier_id_desc,
           tfa.product_link,
           --生产信息
           ...
           fr.quality_step,
           fr.pattern_cap,
           fr.fabric_purchase_cap,
           fr.fabric_check_cap,
           fr.cost_step,
           --验厂结果
           fr.check_person1,
           fr.check_person1_phone,
           fr.check_date,
           fr.check_person2,
  ...
  BEGIN
    ...
    v_query_sql := q'[SELECT fr.FACTORY_REPORT_ID,tfa.certificate_file,
           fr.check_report_file,
           tfa.supplier_gate,
           tfa.supplier_site,
           tfa.supplier_office,
