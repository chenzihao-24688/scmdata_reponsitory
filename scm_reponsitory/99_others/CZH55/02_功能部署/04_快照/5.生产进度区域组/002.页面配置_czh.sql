...
values ('a_report_120', 'look_a_supp_151', 1, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_product_110', 'look_a_supp_151', 1, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_product_150', 'look_a_supp_151', 1, 0, null);

insert into bw3.sys_item_element_rela (ITEM_ID, ELEMENT_ID, SEQ_NO, PAUSE, LEVEL_NO)
values ('a_product_116', 'look_a_supp_151', 1, 0, null);

UPDATE bw3.sys_field_list t SET t.caption = '分组名称' WHERE t.field_name = 'GROUP_NAME_DESC';
END;
/
