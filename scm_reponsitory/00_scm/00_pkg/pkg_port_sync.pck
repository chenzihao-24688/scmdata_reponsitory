CREATE OR REPLACE PACKAGE SCMDATA.pkg_port_sync IS
  ...
  =================================================================================*/
  PROCEDURE p_upd_ordercretimescm
  (
    v_ordid  IN VARCHAR2,
  ...
  =================================================================================*/
  FUNCTION f_build_batch_acsql
  (
    select_sql IN VARCHAR2,
    config_id  IN VARCHAR2,
    user_id    IN VARCHAR2
  ) RETURN CLOB;
  ...
  =================================================================================*/
  PROCEDURE p_orditf_check
  (
    v_relagooid     IN VARCHAR2,
  ...
  =================================================================================*/
  PROCEDURE p_ordered_itf_insert
  (
  ...
  =================================================================================*/
  PROCEDURE p_ordersitem_itf_insert
  (
    v_inordid       IN VARCHAR2,
    v_ingooid       IN VARCHAR2,
    v_insupidbase   IN VARCHAR2,
  ...
  =================================================================================*/
  PROCEDURE p_orderchange_insert_execute
  (
    v_inpcno         IN NUMBER,
  ...
  =================================================================================*/
  PROCEDURE p_change_reason_insert
  (
  ...
  =================================================================================*/
  PROCEDURE p_iu_ord_finishtime_itf
  (
    v_ordid  IN VARCHAR2,
    v_compid IN VARCHAR2,
    v_ftime  IN VARCHAR2
  ...
  =================================================================================*/
  PROCEDURE p_append_qareprela_shoid_by_ordid
  (
  ...
  =================================================================================*/
  FUNCTION f_orderchange_pr_sync
  (
    v_orderid  IN VARCHAR2,
    v_compid   IN VARCHAR2,
    v_gooid    IN VARCHAR2,
  ...
  =================================================================================*/
  FUNCTION f_orderchange_dt_sync
  (
    v_orderid  IN VARCHAR2,
    v_compid   IN VARCHAR2,
    v_gooid    IN VARCHAR2,
  ...
  =================================================================================*/
  FUNCTION f_orderchange_sc_sync
  (
    v_orderid IN VARCHAR2,
    v_compid  IN VARCHAR2,
    v_oldsup  IN VARCHAR2,
    v_newsup  IN VARCHAR2
  ) RETURN NUMBER;
  ...
  =================================================================================*/
  FUNCTION f_orderchange_wh_sync
  (
    v_orderid IN VARCHAR2,
    v_compid  IN VARCHAR2,
    v_oldloc  IN VARCHAR2,
    v_newloc  IN VARCHAR2
  ) RETURN NUMBER;
  ...
  =================================================================================*/
  FUNCTION f_orderchange_sd_sync
  (
    v_orderid IN VARCHAR2,
    v_compid  IN VARCHAR2,
    v_oldsbs  IN VARCHAR2,
    v_newsbs  IN VARCHAR2
  ) RETURN NUMBER;
  ...
  ==================================================================================================================*/
  FUNCTION f_check_cmx_rca_exists
  (
    v_ordid     IN VARCHAR2,
    v_gooid     IN VARCHAR2,
    v_oldprice  IN NUMBER,
  ...
  =================================================================================*/
  FUNCTION f_check_orded_altrans
  (
    v_ordid   IN VARCHAR2,
    v_compid  IN VARCHAR2,
    v_pdednum IN NUMBER
  ...
  =================================================================================*/
  FUNCTION f_check_ordsitem_altrans
  (
    v_ordid     IN VARCHAR2,
    v_compid    IN VARCHAR2,
    v_pditemnum IN NUMBER
  ) RETURN NUMBER;
  ...
  =================================================================================*/
  PROCEDURE p_update_ordleak_isordedget
  (
    v_ordid  IN VARCHAR2,
    v_compid IN VARCHAR2
  );
  ...
  =================================================================================*/
  PROCEDURE p_update_ordleak_isordsget
  (
    v_ordid  IN VARCHAR2,
    v_compid IN VARCHAR2
  );
  ...
  =================================================================================*/
  PROCEDURE p_update_ordleak_isordsitemget
  (
    v_ordid  IN VARCHAR2,
    v_compid IN VARCHAR2
  );
  ...
  =================================================================================*/
  FUNCTION f_get_orderleak_status
  (
    v_issupex   IN NUMBER,
    v_isgooex   IN NUMBER,
    v_isedget   IN NUMBER,
    v_issget    IN NUMBER,
    v_isitemget IN NUMBER
  ) RETURN VARCHAR2;
    ...
    IF v_inordid IS NOT NULL THEN
      ...
      IF v_jugnum = 0 THEN
        ...
        INSERT INTO scm_interface.t_ordered_itf
          (order_id, company_id, order_type, supplier_code, sho_id, goo_id, delivery_date, finish_time, isfirstordered, send_by_sup, is_product_order, memo, rationame, merchandiserid, operate_id, create_time, port_obj, port_status, port_time, err_code, err_msg, retry_num)
        VALUES
          (v_inordid, v_incompid, v_inpotype, v_insupidbase, v_inshoid, v_ingooid, to_date(v_indeliverdate,
                    'YYYY-MM-DD HH24-MI-SS'), to_date(v_infinishtime,
                    'YYYY-MM-DD HH24-MI-SS'), v_inisfirstordered, v_insendbysup, v_inisprodctorder, v_inmemo, v_inrationame, v_inmerchandiserid, v_inoperatorid, to_date(v_increatetime,
                    'YYYY-MM-DD HH24-MI-SS'), 'ORDERED_ITF', v_portstatus, SYSDATE, v_errcode, v_errmsg, 0);
      ELSE
        --修改
    ...
    IF v_inordid IS NOT NULL THEN
      ...
      IF v_jugnum = 0 THEN
        ...
        INSERT INTO scm_interface.t_orders_itf
          (order_id, company_id, goo_id, order_price, order_amount, got_amount, delivery_date, factory_code, memo, is_qc_required, port_obj, port_status, port_time, err_code, err_msg, retry_num)
        VALUES
          (v_inordid, v_incompid, v_ingooid, v_ininprice, v_inorderamount, v_ingotamount, to_date(v_indeliverdate,
                    'YYYY-MM-DD HH24-MI-SS'), v_faccode, v_inmemo, v_inisqcrequired, 'ORDERS_ITF', v_portstatus, SYSDATE, v_errcode, v_errmsg, 0);
      ELSE
        --修改
    ...
    IF v_inordid IS NOT NULL THEN
      ...
      IF v_jugnum = 0 THEN
        ...
        INSERT INTO scm_interface.t_ordersitem_itf
          (order_id, company_id, goo_id, barcode, supplier_code, order_amount, got_amount, memo, port_obj, port_status, port_time, err_code, err_msg, retry_num)
        VALUES
          (v_inordid, v_incompid, v_ingooid, nvl(v_inbarcode, ' '), v_insupidbase, v_inorderamount, v_ingotamount, v_inmemo, 'ORDERS_ITF', v_portstatus, SYSDATE, v_errcode, v_errmsg, 0);
      ELSE
        --修改
      ...
      BEGIN
        ...
        IF v_jugnum = 0 THEN
          INSERT INTO scmdata.t_ordered
            (order_id, company_id, order_code, order_status, order_type, delivery_date, supplier_code, send_order, send_order_date, create_id, create_time, finish_time, origin, memo, sho_id, deal_follower, send_by_sup, isfirstordered, is_product_order, rationame)
          VALUES
            (scmdata.f_get_uuid(), i.company_id, i.order_id, 'OS01', i.order_type, i.delivery_date, v_supcode, i.operate_id, i.create_time, i.operate_id, i.create_time, i.finish_time, 'MS_ORDERED', i.memo, i.sho_id, v_dealfollower, i.send_by_sup, i.isfirstordered, i.is_product_order, i.rationame);
        ELSE
          UPDATE scmdata.t_ordered
        ...
        scmdata.pkg_order_management.p_upd_ordered_qc_qcleader_needcheck(v_inp_order_id   => i.order_id,
      ...
      BEGIN
        ...
        IF v_jugnum = 0 THEN
          INSERT INTO scmdata.t_orders
            (orders_id, company_id, orders_code, order_id, goo_id, order_amount, got_amount, order_price, delivery_date, memo, factory_code, is_qc_required)
          VALUES
            (scmdata.f_get_uuid(), i.company_id, ' ', i.order_id, v_gooid, i.order_amount, i.got_amount, i.order_price, i.delivery_date, i.memo, v_faccode, i.is_qc_required);
        ELSE
    ...
    FOR i IN (SELECT order_id,
      ...
      BEGIN
        ...
        IF v_jugnum = 0 THEN
          ...
          VALUES
            (scmdata.f_get_uuid(), i.company_id, ' ', i.order_id, v_gooid, i.barcode, i.order_amount, i.got_amount, i.memo);
        ELSE
  ...
  BEGIN
    ...
    IF v_jugnum = 0 THEN
      INSERT INTO scmdata.t_commodity_info_ctl
        (ctl_id, itf_id, itf_type, batch_id, batch_num, batch_time, sender, receiver, send_time, receive_time, return_type, return_msg, create_id, create_time, update_id, update_time, remarks, company_id)
      VALUES
        (scmdata.f_get_uuid(), v_gooid, 'GOOD_MAIN', NULL, NULL, SYSDATE, 'mdm', 'scm', SYSDATE, SYSDATE, 'W', '商品货号' ||
          v_gooid ||
          '指定重新导入', 'ADMIN', SYSDATE, 'ADMIN', SYSDATE, NULL, v_compid);

      INSERT INTO scmdata.t_commodity_color_size_ctl
        (ctl_id, itf_id, itf_type, batch_id, batch_num, batch_time, sender, receiver, send_time, receive_time, return_type, return_msg, create_id, create_time, update_id, update_time, remarks, company_id)
      VALUES
        (scmdata.f_get_uuid(), v_gooid, '色码表接口导入', NULL, NULL, SYSDATE, 'mdm', 'scm', SYSDATE, SYSDATE, 'R', '商品货号' ||
          v_gooid ||
          '指定重新导入', 'ADMIN', SYSDATE, 'ADMIN', SYSDATE, NULL, v_compid);

      INSERT INTO scmdata.t_commodity_composition_ctl
        (ctl_id, company_id, inf_id, goo_id, composname, loadrate, goo_raw, receive_time, create_time, memo, sort, return_type, return_msg, itf_type, sender, receiver)
      VALUES
        (scmdata.f_get_uuid(), v_compid, v_gooid, v_gooid, NULL, NULL, NULL, SYSDATE, SYSDATE, NULL, NULL, 'R', '商品货号' ||
          v_gooid ||
          '指定重新导入', 'GOODS_COMPOSITION', 'mdm', 'scm');
    END IF;
  ...
  BEGIN
    ...
    IF v_msg IS NOT NULL THEN
      INSERT INTO scmdata.sys_company_wecom_msg
        (company_wecom_msg_id, robot_type, company_id, status, create_time, create_id, msgtype, content, mentioned_list, mentioned_mobile_list)
      VALUES
        (scmdata.f_get_uuid(), 'SUP_MISS_MSG', 'b6cc680ad0f599cde0531164a8c0337f', 2, SYSDATE, 'ADMIN', 'markdown', '#### 订单接口错误通知
供应商编号<font color=''warning''>[' ||
          v_msg ||
          ']</font>不存在于scm。
<@JML26><@TQQ53>', 'JML26;TQQ53', NULL);
    END IF;
  ...
  BEGIN
    ...
    IF v_mode = 'GR'
       AND v_ptstatus = 'ER'
       AND instr(v_errcode, 'G') > 0 THEN
      v_checkstr := '货号缺失:';
      v_repcode  := 'G';
    ELSIF v_mode = 'SR'
          AND v_ptstatus = 'ER'
          AND instr(v_errcode, 'S') > 0 THEN
      v_checkstr := '供应商缺失:';
      v_repcode  := 'S';
    END IF;
    ...
    IF v_startidx = 1
       AND v_endidx = length(v_errmsg) THEN
      v_ptstatus := 'SP';
      v_errcode  := '';
      v_errmsg   := '';
    ELSE
    ...
    IF v_jugnum = 0
      ...
      IF v_inchangetype = 'SC'
        ...
        IF v_gooid IS NOT NULL THEN
          --当旧供应商档案和新供应商档案都存在
          IF (v_inoldsupplier IS NULL OR v_oldsup IS NOT NULL)
             AND v_newsup IS NOT NULL THEN
          ...
          ELSIF (v_oldsup IS NULL AND v_newsup IS NOT NULL AND
                v_inoldsupplier IS NOT NULL)
                OR ((v_inoldsupplier IS NULL OR v_oldsup IS NOT NULL) AND
            ...
            v_exesql := 'INSERT INTO SCMDATA.T_ORDER_INTERFACE_ERR' ||
                        ...
                        '}'',q''{' || v_ev || '}'',0)';
            --当旧供应商档案和新供应商档案都不存在
          ELSIF v_oldsup IS NULL
                AND v_newsup IS NULL
                AND v_inoldsupplier IS NOT NULL THEN
            v_type   := 'DSM';
        ...
        ELSE
          ...
          IF v_oldsup IS NOT NULL
            ...
            v_exesql := 'INSERT INTO SCMDATA.T_ORDER_INTERFACE_ERR' ||
                        ...
                        '}'',q''{' || v_ev || '}'',0)';
            --当旧供应商档案和新供应商档案只有一个存在
          ELSIF (v_oldsup IS NULL AND v_newsup IS NOT NULL)
                OR (v_oldsup IS NOT NULL AND v_newsup IS NULL) THEN
            --当新供应商档案存在
            IF v_oldsup IS NULL THEN
              v_type   := 'GOSM';
        ...
        END IF;
        --当类型为单价变更，且商品档案存在
      ELSIF v_inchangetype = 'PR'
            AND v_jugnum = 0
            AND v_gooid IS NOT NULL THEN
  ...
  BEGIN
    ...
    IF v_prodesc IS NOT NULL
       AND v_delay_problem_class_pr IS NOT NULL
       AND v_delay_cause_class_pr IS NOT NULL
       AND v_delay_cause_detailed_pr IS NOT NULL THEN
    ...
    IF v_ordid IS NOT NULL THEN
      ...
      IF v_jugnum = 0 THEN
        INSERT INTO scm_interface.t_ord_finishtime_itf
          (order_id, company_id, finish_time, port_obj, port_time, port_status)
        VALUES
  ...
  BEGIN
    ...
    IF v_newsbs = 1 THEN
      FOR z IN (SELECT *
        ...
        FOR x IN (SELECT delivery_record_id,
                         company_id
  ...
  BEGIN
    ...
    IF v_jugnum = 0 THEN
      INSERT INTO scmdata.t_order_leak
        (order_id, company_id, status, order_cttime, sup_id_base, goo_id, orded_num, is_ordedget, ords_num, is_ordsget, ordsitem_num, is_ordsitemget)
      VALUES
        (v_ordid, v_compid, v_status, v_cretime, v_supidbase, v_gooid, v_ordednum, v_isedget, v_ordsnum, v_issget, v_ordsitemnum, v_isitemget);
    ELSE
      UPDATE scmdata.t_order_leak
         SET status         = v_status,
