CREATE OR REPLACE PACKAGE SCMDATA.pkg_capacity_inqueue_prd IS
...
END pkg_capacity_inqueue_prd;
/

CREATE OR REPLACE PACKAGE BODY SCMDATA.pkg_capacity_inqueue_prd IS
  ...
  BEGIN
    ...
    -- 入队
    scmdata.pkg_queue_prd.p_gen_queuevc_info(v_queueid   => v_queueid,
                                         v_compid    => v_compid,
                                         v_tab       => v_tab,
                                         v_viewtab   => v_viewtab,
    ...
    scmdata.pkg_capacity_iflrow_prd.p_influencerows_core(v_queueid => v_queueid,
                                                     v_compid  => v_compid);
