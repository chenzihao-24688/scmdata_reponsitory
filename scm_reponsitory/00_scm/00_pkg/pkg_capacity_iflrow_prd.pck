CREATE OR REPLACE PACKAGE SCMDATA.pkg_capacity_iflrow_prd IS
...
END pkg_capacity_iflrow_prd;
/

CREATE OR REPLACE PACKAGE BODY SCMDATA.pkg_capacity_iflrow_prd IS
