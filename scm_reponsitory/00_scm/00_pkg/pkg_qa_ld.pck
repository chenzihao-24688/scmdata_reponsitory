...
VALUES
 ...
 WHERE asn_id = :v_inp_asnid
   ...
   AND company_id = :v_inp_compid';
    ...
    --执行 v_sql
    EXECUTE IMMEDIATE v_sql
      USING v_inp_status, v_inp_errinfo, v_inp_asnid, v_inp_gooid, v_inp_barcode, v_inp_compid;
...
VALUES
  (:v_inp_asnid,
   ...
   :v_inp_wmsskucheckresult)';
    ...
    EXECUTE IMMEDIATE v_sql
      USING v_inp_asnid, v_inp_compid, v_inp_ordid, v_inp_gooid, nvl(v_inp_barcode, v_inp_gooid), v_inp_pcomeamt, v_inp_gotamt, v_inp_qualdecreamt, v_inp_qualpassamt, v_inp_qualresult, v_inp_unqualprosresult, v_inp_arrretnum, v_inp_aereason, v_inp_pcomedate, v_inp_scantime, v_inp_receivetime, v_inp_qualfinishtime, v_inp_colorname, v_inp_sizename, v_inp_datasource, v_inp_wmsskucheckresult;
  EXCEPTION
    WHEN priv_exception THEN
      --抛出报错
      raise_application_error(-20002, v_sqlerrm);
    WHEN OTHERS THEN
      ...
      v_errinfo := 'Error Object:' || v_selfdescription || chr(10) ||
                   ...
                   'v_inp_gotamt: ' || to_char(v_inp_gotamt) || chr(10) ||
                   'v_inp_qualdecreamt: ' || to_char(v_inp_qualdecreamt) ||
                   chr(10) || 'v_inp_qualpassamt: ' ||
                   to_char(v_inp_qualpassamt) || chr(10) ||
                   'v_inp_qualresult: ' || v_inp_qualresult || chr(10) ||
                   'v_inp_unqualprosresult: ' || v_inp_unqualprosresult ||
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      ...
      v_errinfo := 'Error Object:' || v_selfdescription || chr(10) ||
                   ...
                   to_char(v_inp_qualpassamt) || chr(10) ||
                   'v_inp_qualresult: ' || v_inp_qualresult || chr(10) ||
                   'v_inp_arrretnum: ' || to_char(v_inp_arrretnum) ||
                   chr(10) || 'v_inp_aereason: ' || v_inp_aereason ||
                   chr(10) || 'v_inp_pcomedate: ' ||
                   to_char(v_inp_pcomedate, 'yyyy-mm-dd hh24-mi-ss') ||
                   chr(10) || 'v_inp_scantime: ' ||
                   to_char(v_inp_scantime, 'yyyy-mm-dd hh24-mi-ss') ||
                   chr(10) || 'v_inp_receivetime: ' ||
 ...
 (asn_id, company_id, order_id, pcome_amount, got_amount, qual_decreamount, qual_passamount,
  qual_result, unqual_prosresult, arrive_retnum, ae_reason, pcome_date, scan_time, receive_time,
  qual_finishtime)
VALUES
  (:v_inp_asnid, :v_inp_compid, :v_inp_ordid, :v_inp_pcomeamt, :v_inp_gotamt, :v_inp_qualdecreamt,
   ...
   :v_inp_pcomedate, :v_inp_scantime, :v_inp_receivetime, :v_inp_qualfinishtime)';
    ...
    --执行 sql
    EXECUTE IMMEDIATE v_sql
      USING v_inp_asnid, v_inp_compid, v_inp_ordid, v_inp_pcomeamt, v_inp_gotamt, v_inp_qualdecreamt, v_inp_qualpassamt, v_inp_qualresult, v_inp_unqualprosresult, v_inp_arrretnum, v_inp_aereason, v_inp_pcomedate, v_inp_scantime, v_inp_receivetime, v_inp_qualfinishtime;
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      ...
      v_errinfo := 'Error Object:' || v_selfdescription || chr(10) ||
                   ...
                   'got_amount: ' || to_char(v_inp_gotamt) || chr(10) ||
                   'v_inp_qualdecreamt: ' || to_char(v_inp_qualdecreamt) ||
 ...
 WHERE asn_id = :v_inp_asnid
   AND company_id = :v_inp_compid';
    ...
    --执行 sql
    EXECUTE IMMEDIATE v_sql
      USING v_inp_ordid, v_inp_pcomeamt, v_inp_gotamt, v_inp_qualdecreamt, v_inp_qualpassamt, v_inp_qualresult, v_inp_unqualprosresult, v_inp_arrretnum, v_inp_aereason, v_inp_pcomedate, v_inp_scantime, v_inp_receivetime, v_inp_qualfinishtime, v_inp_asnid, v_inp_compid;
    ...
    v_sql := 'SELECT repsku.asn_id,
       ...
       CASE
         WHEN repsku.skucheck_result = ''PS'' THEN
          decode(repsku.got_amount,
                 NULL,
                 repsku.pcome_amount - repsku.qualdecrease_amount,
                 repsku.got_amount - repsku.qualdecrease_amount)
 ...
 WHERE (repsku.qa_report_id, repsku.company_id) IN
  ...
  FROM (SELECT asn_id,
               ...
               SUM(NVL(got_amount, 0)) got_amount,
  ...
  BEGIN
    ...
    v_sql := 'SELECT SUM(pcome_amount), SUM(got_amount) FROM scmdata.t_asnorders WHERE INSTR(:a, asn_id)>0 AND company_id = :b';
...
VALUES
  (:v_inp_qarepid,
   ...
   :v_inp_prereprocessingsumamount)';
    ...
    --执行 sql
    EXECUTE IMMEDIATE v_sql
      USING v_inp_qarepid, v_inp_compid, v_inp_firstsamplingamount, v_inp_addsamplingamount, v_inp_unqualsamplingamount, v_inp_pcomesumamount, v_inp_gotsumamount, v_inp_qualdecreasesumamount, v_inp_prereprocessingsumamount;
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      ...
      v_errinfo := 'Error Object:' || v_selfdescription || chr(10) ||
                   ...
                   to_char(v_inp_gotsumamount) || chr(10) ||
                   'qualdecreasesum_amount: ' ||
  ...
  BEGIN
   ...
   SET firstsampling_amount      = :v_inp_firstsamplingamount,
       ...
       gotsum_amount             = :v_inp_gotsumamount,
 ...
 WHERE qa_report_id = :v_inp_qarepid
   AND company_id = :v_inp_compid';
    ...
    --执行 sql
    EXECUTE IMMEDIATE v_sql
      USING v_inp_firstsamplingamount, v_inp_addsamplingamount, v_inp_unqualsamplingamount, v_inp_pcomesumamount, v_inp_gotsumamount, v_inp_qualdecreasesumamount, v_inp_prereprocessingsumamount, v_inp_qarepid, v_inp_compid;
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      ...
      v_errinfo := 'Error Object:' || v_selfdescription || chr(10) ||
                   ...
                   chr(10) || 'pcome_amount: ' ||
                   to_char(v_inp_pcomeamount) || chr(10) || 'got_amount: ' ||
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      ...
      v_errinfo := 'Error Object:' || v_selfdescription || chr(10) ||
                   ...
                   chr(10) || 'got_amount: ' || to_char(v_inp_gotamount) ||
...
VALUES
 ...
 WHERE qa_report_id = :v_inp_qarepid
  ...
  BEGIN
    ...
    v_sql := 'SELECT asned.asn_id,
       ...
       asns.goo_id,
       asnitemitf.barcode,
       asnitemitf.pcome_amount,
       asnitemitf.got_amount,
       asned.pcome_date,
       asned.scan_time,
 ...
 INNER JOIN scmdata.t_asnorders asns
    ON asned.asn_id = asns.asn_id
   AND asned.company_id = asns.company_id
  LEFT JOIN scmdata.t_asnordersitem_itf asnitemitf
 ...
 WHERE qa_report_id = :v_inp_qarepid
  ...
  BEGIN
    ...
    --构建sql
    v_sql := 'SELECT repnum.firstsampling_amount,
       repnum.addsampling_amount,
       rep.checkers,
       rep.checkdate,
       rep.check_result,
       rep.problem_descriptions,
       rep.review_comments,
       rep.problem_classification,
       repnum.unqualsampling_amount,
       repdetail.yy_result,
       repdetail.yy_uqualsubjects,
       repdetail.mfl_result,
       repdetail.mfl_uqualsubjects,
       repdetail.gy_result,
       repdetail.gy_uqualsubjects,
       repdetail.bx_result,
       repdetail.bx_uqualsubjects,
       repdetail.scale_amount
 ...
 WHERE qa_report_id = :v_inp_qarepid
  ...
  BEGIN
    ...
    --获取质检报告状态
    v_isasnnotreceived := scmdata.pkg_qa_da.f_isrepasnnotreceived(v_inp_qarepid => v_inp_qarepid,
                                                                  v_inp_asnid   => v_inp_asnid,
                                                                  v_inp_compid  => v_inp_compid);

    --当质检报告asn已上架
    IF v_isasnnotreceived = 0 THEN
      --获取报告质检结果
          ...
          ELSE
            ...
            ELSIF nvl(v_repprocessingtype, 'PBCC') = 'PBCC' THEN
              ...
              IF i.skucheck_result = 'PS' THEN
                --sku质检结果=【合格】，回传结果=【通过】
                v_transresult := 'PS';
              ELSIF i.skucheck_result = 'NP' AND
                    i.skuprocessing_result IN
                    ('CR', 'CWR', 'WR', 'ADQ', 'DR', 'DSR', 'GR') THEN
                --sku质检结果=【不合格】，sku处理结果=【让步收货/警告收货/严重警告收货/扣款收货/代销收货/担保收货/加抽合格】，回传结果=【通过】
                v_transresult := 'PS';
              ELSIF i.skucheck_result = 'NP' AND
                    i.skuprocessing_result = 'WD' THEN
                --sku质检结果=【不合格】，sku处理结果=【批退】，回传结果=【不通过】
                v_transresult := 'NP';
              ELSIF i.skucheck_result = 'NP' AND
                    i.skuprocessing_result = 'AWR' THEN
        ...
        EXCEPTION
          WHEN OTHERS THEN
            ...
            v_errinfo := 'Error Object:' || v_selfdescription || chr(10) ||
                         ...
                         chr(10) || 'v_inp_compid: ' || v_inp_compid ||
                         chr(10) || 'v_inp_asnid: ' || v_inp_asnid ||
 ...
 WHERE rep.qa_report_id = ''' || v_inp_qarepid || '''
  ...
  BEGIN
    ...
    FROM (SELECT sup.supplier_company_abbreviation supname,
  ...
  BEGIN
    ...
    --构建执行 sql
    v_sql := 'SELECT MAX(sup.supplier_company_abbreviation || '', '' || goo.rela_goo_id || '', '' ||
