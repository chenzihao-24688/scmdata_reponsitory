  ...
  BEGIN
    ...
    IF p_pro_rec.progress_status <> p_status THEN
      ...
      IF v_suc_count = v_pr_tol THEN
        ...
        ----20230505 zc314 begin 
        ----需求说明: 订单新增 Qc/Qc主管字段，结束订单时赋值到 scmdata.t_ordered 
        scmdata.pkg_order_management.p_upd_ordered_qc_qcleader_needcheck(v_inp_order_id   => p_pro_rec.order_id,
                                                                         v_inp_company_id => p_pro_rec.company_id);
        ----20230505 zc314 end
      ...
      IF p_abn_rec.anomaly_class IS NOT NULL AND
        ...
        IF p_abn_rec.anomaly_class = 'AC_QUALITY' THEN
          ...
          IF p_abn_rec.detailed_reasons = ' ' OR
             ...
             p_abn_rec.problem_class = ' ' OR
             p_abn_rec.handle_opinions IS NULL THEN
  ...
  BEGIN
    ...
    VALUES
      (p_abn_rec.abnormal_id,
       ...
       p_abn_rec.orgin_type,
       p_abn_rec.abnormal_orgin,
       p_abn_rec.checker,
       p_abn_rec.check_link,
       p_abn_rec.check_num);
