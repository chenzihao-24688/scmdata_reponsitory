  ...
  begin
    for x in (select *
      ...
      for w in (select b.target_user_id,
                       ...
                       xmlagg(xmlparse(content b.param || ';' wellformed) ORDER BY 1).getclobval() param,
        ...
        */
        ...
        /*update scmdata.sys_group_wecom_msg_cache b
           set b.status = -1
         where b.sys_group_wecom_msg_cache_id = x.sys_group_wecom_msg_pattern_id;*/
      end loop;
      --to发送机器人缓存消息
      for w in (select b.target_user_id,
                       b.target_robot_code,
       ...
       /* update scmdata.sys_group_wecom_msg_cache b
           set b.status = -1
         where b.sys_group_wecom_msg_cache_id =
               x.sys_group_wecom_msg_pattern_id;*/
      end loop;
    end loop;
    update scmdata.sys_group_wecom_msg_cache b
       set b.status = -1
